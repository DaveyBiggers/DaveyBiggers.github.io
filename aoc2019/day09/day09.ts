...
readFile("assets/day09.txt", { encoding: 'utf8' })
...
{
    console.log("999 + 999 =", add_strings("999", "999"));
    console.log("999 - 999 =", add_strings("999", "-999"));
    console.log("1234 + 4321 =", add_strings("1234", "4321"));
    console.log("1234 - 4321 =", add_strings("1234", "-4321"));
    console.log("-1234 + 4321 =", add_strings("-1234", "4321"));
    console.log("-1234 - 4321 =", add_strings("-1234", "-4321"));

    console.log("34463338 x 34463338 as numbers:", 34463338 * 34463338);
    console.log("34463338 x 34463338 as strings:", multiply_strings("34463338", "34463338"));
    console.log("34463338 x 34463338 as strints:", multiply_strints(34463338, 34463338));
